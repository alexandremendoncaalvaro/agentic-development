...
* [ADR-0023](doc/adr/0023-agentic-commit-skill.md) — Workflow-operational skill `agentic-commit` for atomic Conventional Commits with DCO sign-off
* [ADR-0024](doc/adr/0024-agentic-pr-skill.md) — Workflow-operational skill `agentic-pr` for opening pull requests with uniform body shape
* [ADR-0025](doc/adr/0025-agentic-merge-skill.md) — Workflow-operational skill `agentic-merge` for evaluating and merging pull requests
