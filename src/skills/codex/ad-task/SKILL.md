...
non-empty `Scope ref` resolves to a repository-local source artifact. `Evidence
ref` is blank unless an existing durable record directly grounds the task. Notes
