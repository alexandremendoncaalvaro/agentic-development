...
- The user wants to open a PR after committing → continue with `agentic-pr` (ADR-0024) after this skill finishes.
- The user wants to merge an open PR → `agentic-merge` (ADR-0025).
...
- After commits land: `agentic-pr` (ADR-0024) to open the PR.
- After PR open and CI green: `agentic-merge` (ADR-0025) to evaluate and merge.
- If a hook failure exposed recurring drift: `agentic-audit`.
