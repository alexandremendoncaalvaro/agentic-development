...
All 60 accepted ADRs bind in full, except the nineteen below, which bind except for the named part.
...
| [0073](0073-skill-invocation-policy-and-listing-budget.md) | `ad-rules`, `ad-pr`, and `ad-merge` membership in the user-invocable-only class | The blast-radius classification rule, every other named class member, and all listing budgets | [ADR-0076](0076-compose-a-canonical-decision-maker-brief.md); [ADR-0084](0084-reclassify-pr-and-merge-behind-an-approval-gate.md) |
