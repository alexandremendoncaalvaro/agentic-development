...
All 61 accepted ADRs bind in full, except the nineteen below, which bind except for the named part.
...
| [0073](0073-skill-invocation-policy-and-listing-budget.md) | The invoker-class rule and its user-invocable-only class, with every member; the 8,000-character total for model-invocable descriptions | The per-description caps, now for every skill: 350 characters with the use case and triggers first, and the 1,024-character specification maximum | [ADR-0076](0076-compose-a-canonical-decision-maker-brief.md); [ADR-0084](0084-reclassify-pr-and-merge-behind-an-approval-gate.md); [ADR-0085](0085-gate-skill-effects-inside-the-skill.md) |
