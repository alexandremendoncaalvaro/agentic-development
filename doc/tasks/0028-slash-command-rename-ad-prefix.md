...
ADR-0026 accepts the slash-command rename for ergonomics (`/agentic-X` is 9 prefix chars; `/ad-X` is 2). Breaking change is null-cost while the kit has no external users.
...
- [x] ADR-0026 accepted with the 23-skill mapping table and the rename-surface / preserve scope.
...
- [x] Draft + accept ADR-0026 (commit b5a7089).
