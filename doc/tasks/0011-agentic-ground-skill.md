...
- [x] [`src/skills/codex/agentic-ground/SKILL.md`](../../src/skills/codex/agentic-ground/SKILL.md) exists with the matching content shaped to the Codex `<background_information>` / `<instructions>` / `<output_contract>` template plus an `agents/openai.yaml`. Body documents the auto-trigger asymmetry per ADR-0010 §6.
