...
- [ ] All briefs that can encounter a platform identifier agree on substance; any remaining wording differences are host-shape differences, not policy differences.
...
- [ ] Read the three briefs that carry the guard; extract its substance as they state it.
