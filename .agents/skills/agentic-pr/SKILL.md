...
- The branch has uncommitted or unsplit work → `agentic-commit` first (ADR-0023).
- The user wants to merge an already-open PR → `agentic-merge` (ADR-0025).
...
- When CI is green: `agentic-merge` (ADR-0025) to evaluate and merge.
- If a fresh-context review is wanted before merge: `agentic-review` (WORKFLOW §10).
