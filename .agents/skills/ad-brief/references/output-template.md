# Decision-maker brief template

```markdown
### Brief

- **Project:** <what this project delivers, in plain language>
- **Final objective:** <the result the current work is moving toward>
- **Recent result:** <what just changed or was learned, and what it means>
- **Now:** <the current target and immediate next action>
- **Why it matters:** <the value, risk, or failure this target addresses>
- **Next:** <the direction after the current target>
