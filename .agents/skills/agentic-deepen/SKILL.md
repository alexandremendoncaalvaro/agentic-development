...
- The friction is a *naming/vocabulary* drift — `agentic-domain` (ADR-0019).
- The friction is *missing context*, not module shape — `agentic-grill` (ADR-0022).
...
1. Walk the design tree of the proposal branch by branch (one question per turn, recommendation included). Reuse the `agentic-grill` discipline.
